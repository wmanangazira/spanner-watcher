...
class WatchSetOfTablesExample {
   ...
   */
  static String table = "Singers";
  static String table1 = "Albums";
  static SpannerDatabaseChangeWatcher createWatcher(Spanner spanner, DatabaseId databaseId) {
    ...
    SpannerDatabaseChangeWatcher watcher =
        SpannerDatabaseTailer.newBuilder(spanner, databaseId).includeTables(table, table1).build();
